...
namespace IdentityServer.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register()
        {
            ...
            {
                UserName = "almeidafelipewanted@gmail.com",
                Name = "Felipe Almeida",
                Email = "almeidafelipewanted@gmail.com"
            };

            var result = await _userManager.CreateAsync(user, "SERV202torpedo!");
            ...
            await _userManager.AddClaimAsync(user, new System.Security.Claims.Claim("monkeyCan", "banana"));

            return Ok(new RegisterResponseViewModel(user));
        }

        [HttpGet]
        public async Task<IActionResult> RegisterBob()
        {
            var user = new AppUser
            {
                UserName = "bob",
        ...
        {
            var user = await _userManager.FindByIdAsync("a5b27260-820e-45f9-ba89-8f14a2289375");
